...
// Last modified 20230421T1711+0200.
...
and its loader must be in the path. 
...
The <sin_forth> loader is a shell script. In order to make it
accessible anywhere, you can copy or link it to any directory in your
path.

Example:

----
ln -s ~/YOUR-PATH/src/sin_forth DIR
----

where "YOUR-PATH" must be replaced with the corresponding path to Sin
Forth's <src> directory on your system, and "DIR" can be replaced with
